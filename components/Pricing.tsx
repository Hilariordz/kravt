...
const PLANS = [
  {
    ...
    price: "$300",
    period: "/mes",
    sub: "Ideal para entrenar a tu propio ritmo",
    accent: false,
    image: "/pack1.png",
    features: [
      { icon: "⚡", text: "Acceso libre al área de pesas y cardio" },
      { icon: "🔒", text: "Acceso a vestuarios y regaderas" },
      { icon: "📱", text: "Rutina general en la app de seguimiento" },
    ],
  },
  {
    id: "premium",
    label: "Plan Pro / Total",
    price: "$600",
    period: "/mes",
    sub: "Acceso total + Clases ilimitadas con entrenador",
    accent: true,
    image: "/pack2.png",
    features: [
      { icon: "⚡", text: "Todo lo del plan Básico incluido" },
      { icon: "🏃", text: "Clases grupales ilimitadas por semana" },
      { icon: "🍏", text: "Guía de nutrición y hábitos deportivos" },
      { icon: "🎯", text: "Asesoría personalizada mensual con coach" },
    ],
  },
];
